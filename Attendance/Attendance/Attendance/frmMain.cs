...
namespace Attendance
{
    public partial class frmMain : Form
    {
        ...
        {
            Form5 shwFrm5 = new Form5();
            shwFrm5.Text = "Generate Payroll";
            shwFrm5.MdiParent = this.ParentForm;
            shwFrm5.Show();
        }

        private void frmMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            const string message = "Are you sure you want to close AP Application Now?";
        ...
        private void dTRGenerationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmAttendanceSummary showFrm7 = new frmAttendanceSummary();
            showFrm7.MdiParent = this.ParentForm;
            showFrm7.Show();
        }
